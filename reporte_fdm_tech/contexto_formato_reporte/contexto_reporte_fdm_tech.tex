...
\begin{center}
  {\LARGE \textbf{Contexto - Reporte FDM Tech}}\\
  \vspace{2mm}
...
con precision el contenido, formato y reglas del Reporte FDM Tech.
...
resume las actividades semanales del FDM Tech. Incluye
...
distinta a FDM Tech. En el encabezado se debe evitar duplicar "FDM Tech" en
lineas consecutivas. En el resumen se debe usar el campo "Area" con el valor
Electronica / Mecanica / Programacion y el cargo abreviado "Dir. FDM Tech".
...
visual debe mantener la identidad FDM Tech con colores azul oscuro y acentos claros.
...
El director de FDM Tech es José Campos y debe figurar con el
cargo abreviado "Dir. FDM Tech" en el resumen. Este dato debe tratarse como
